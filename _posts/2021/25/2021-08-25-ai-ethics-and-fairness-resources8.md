...
- [The Trouble with Bias](https://www.youtube.com/watch?v=fMym_BKWQzk) by Kate Crawford - This talk, given at the Neural Neural Information Processing Systems (NIPS) in 2017. Not only does Kate goes over what exactly is bias in machine learning models, but she also goes over the harms that it can cause.
    
- [Machine Learning and Fairness](https://www.youtube.com/watch?v=ZtN6Qx4KddY) by Hanna Wallach and Jennifer Wortman Vaughan - This is actually one of my favorite resources on the list. This video goes into several aspects of fairness in machine learning including types of bias that can be in your data as well as ways to help mitigate it such as the Datasheets for Data paper that's linked in the papers section.
    
- [Transparency and Intelligibility Throughout the Machine Learning Life Cycle](https://www.youtube.com/watch?v=I-TSjiXGfSI) by Jennifer Wortman Vaughan - This goes through the entire machine learning life cycle to best incorporate transparency throughout the life cycle.
...
- [FastAI Ethics](https://ethics.fast.ai/) - FastAI's ethics course is probably one of the most comprehensive out there. It has several lectures and each lecture has supplemental materials such as articles and even research papers.
...
- [Interpretable AI](https://www.manning.com/books/interpretable-ai) by Ajay Thampi - One of the first books I've seen on this subject, this book helps you understand why the need for having models that are interpretable and shows how to do it.
...
- [Manipulating and Measuring Model Interpretability](https://www.microsoft.com/en-us/research/publication/manipulating-and-measuring-model-interpretability/) - This paper goes into how to measure model interpretability. It also helps answer the question about what is interpretability in terms of a machine learning model.
    
- [Datasheets for Datasets](https://arxiv.org/pdf/1803.09010.pdf) - In electronics, there is a datasheet accompanied by each component that describes its characteristics, any testing done on it, etc. This paper proposes the idea of having the same for machine learning data.
    
- [AI Fairness Checklist](https://www.microsoft.com/en-us/research/project/ai-fairness-checklist/) - This document has a checklist that one can follow throughout the lifecycle of creating a model to lookout for fairness.
...
- [Microsoft Fairlearn](https://fairlearn.org/) - This Python tool helps access the fairness in your data. There is a [demo](https://www.youtube.com/watch?v=Ts6tB2p97ek) available for this that helps show how it works.
    
- [Microsoft InterpretML](https://interpret.ml/) - Another Python tool to help interpret machine learning models. This one also has a [demo](https://www.youtube.com/watch?v=WwBeKMQ0-I8) available.
