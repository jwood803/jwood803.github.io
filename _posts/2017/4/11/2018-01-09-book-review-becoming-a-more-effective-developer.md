...
As Carol Dweck mentions in her book [Mindset](http://amzn.to/2FeNtm3), the most successful people have a certain mindset in terms of how they view their learning. They believe that your brain can be changed and you can learn anything once you put in the work. That's definitely true for programmers.
...
One of my favorite authors, [Tim Ferriss](https://tim.blog/) often talks about being efficient vs. being effective to help [boost productivity](https://blog.trello.com/productivity-tips-from-tim-ferriss):
...
This is similar to [Getting Things Done](http://amzn.to/2m7RCj9) in that you define clear tasks and prioritize the ones that need to be done. I would also argue to break up bigger tasks into much smaller ones.
...
There's also the book [Software Estimation](http://amzn.to/2CHDILF) that can give a lot more details in improving your estimation details.
...
How often have you come across this scenario: you implement a new feature and the deadline is very close, however your boss wants you to go ahead and get it in to start testing. You mention how many more tests you need to write, yet your boss says to not worry about that and just check it in. Often referred to as [technical debt](https://en.wikipedia.org/wiki/Technical_debt), us programmers can perfectionists in that we want our code to be perfect before we send out for all to work on and see.
...
This book is definitely worth reading for a lot of ideas on how you can easily improve your effectiveness as a programmer. For even more you can checkout the [book's blog](http://www.effectiveengineer.com/blog).
