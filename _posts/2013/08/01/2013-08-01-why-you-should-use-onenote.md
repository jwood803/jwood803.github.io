...
The only downside I have about OneNote is that it's not the best for clipping web articles. Sure it's nice to be able to save links, but I believe it's best to be able to clip the entire article into OneNote. That way you won't be dependent on if that article or even the site is still available. For web clippings I do use [Evernote](http://evernote.com/) and their web clipper. Hopefully in a future update this can be done straight through OneNote itself.
