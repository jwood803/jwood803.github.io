...
- **Learn more design patterns** \- I've stayed away from learning design patterns but no longer! I think it's time to learn these and I'll be using PluralSight's [Design Pattern Library](http://www.pluralsight.com/training/Courses/TableOfContents/patterns-library) course to help me out.
...
- **More JavaScript** - This is the number one thing I need to learn more of, currently. When JavaScript is [considered](http://readwrite.com/2013/08/09/why-javascript-will-become-the-dominant-programming-language-of-the-enterprise) the most dominant language now, it's a good time to learn more of it.
