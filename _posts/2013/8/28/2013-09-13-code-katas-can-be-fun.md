...
For our first shot at a kata we decided to try [Poker Hands](http://www.codingdojo.org/cgi-bin/wiki.pl?KataPokerHands) (you're always welcome to view my [progress](https://github.com/jwood803/Katas)), which we had to rank two player's poker hand and determine who won and display how they won (high card or higher set of cards). Not exactly the easiest kata to do, especially when doing it in a language you're definitely not familiar with, but we thought it was one that could give us a good challenge.  

Another aspect to doing katas is to do solve very small problems. One of my favorite ways to do this lately is by playing around at [Code Wars](http://www.codewars.com/). I've been messing with the JavaScript and Ruby katas there and have been learning quite a lot about the languages as each new kata I do gets progressively harder. They have a pretty slick interface, as well.
