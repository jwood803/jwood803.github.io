...
A colleague and I were asked to become adjunct trainers to help out with some of this training. When I was asked to join I first thought, "Crap, this is going to be really scary being up in front of folks for two full days!". But then I remembered that the best way to grow is to [get out of your comfort zone](http://www.forbes.com/sites/jacobmorgan/2015/02/11/why-getting-out-of-your-comfort-zone-is-the-best-thing-you-can-do-for-your-career/#57effad9652d). So I accepted.

During the time up until the actual training, I learned a lot about how much preparing and practicing really does matter even though it's the last thing I want to do for it. It was also around that time that I heard a [Hidden Brain episode on grit](http://www.npr.org/2016/04/04/472162167/the-power-and-problem-of-grit). The lesson learned there is that using your grit to do things is the least fun experience, but it helps reap in the rewards once it's all done that much more. I then took preparing more seriously. I even took a hiatus from reading books! That's something that hardly ever happens.
...
- [If You Build It: Making Apps for Humans](https://youtu.be/UTX-xTr_Y70) - A wonderful presentation that showcases several interviews the presenter had with, not only some other developers, but with people you would encounter on the street with other careers besides tech. Honestly, this made me want to attempt something similar in my home town.
- [Becoming a XAML Master](https://youtu.be/H6UOrSyhTEE) - I've done XAML in Xamarin Forms for around a year and half now and have come to really enjoy using it for building up my UI. This session covers a few extra tricks I can incorporate to utilize the power of XAML instead of having to write out extra code.
- [Enhancing Your Mobile Application with Machine Learning](https://youtu.be/NtJVld7vJOs) - I've been interested in data science and machine learning for a while now and this was the perfect session to get me started on the path of learning more of it. Great demos in this one!
- [Mobile Apps in F#](https://youtu.be/luLTVlbDAkk) - Of course I have to go to an F# session! This one really drives examples of why you should try F# and some demos of using it in Xamarin applications. The async and MailboxProcessor stuff here is really digestible!
...
![](https://images.squarespace-cdn.com/content/v1/521545a6e4b0734032a27076/1462382327839-2MTPTBX1X7ES2LVNQWJ6/image-asset.png?format=original)
...
![](https://images.squarespace-cdn.com/content/v1/521545a6e4b0734032a27076/1462382454604-7DSL6TAJ86AUT4TQRHMN/image-asset.png?format=original)
