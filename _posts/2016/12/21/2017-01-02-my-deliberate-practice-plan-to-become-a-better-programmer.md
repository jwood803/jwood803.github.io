...
- Use sites like [Pluralsight](https://www.pluralsight.com/) and [Udemy](https://www.udemy.com/courses/development/) for on-demand tutorials and training.
...
- Read and try to understand at least one journal paper on programming each quarter.
    - I plan on starting with [this list](http://blog.fogus.me/2011/09/08/10-technical-papers-every-programmer-should-read-at-least-twice/). From there the [Papers We Love](https://github.com/papers-we-love/papers-we-love) site looks to have a ton more to go through.
...
- Use a time tracker such as [Plan](https://getplan.co/) to keep a digital record and for some nice reports.
